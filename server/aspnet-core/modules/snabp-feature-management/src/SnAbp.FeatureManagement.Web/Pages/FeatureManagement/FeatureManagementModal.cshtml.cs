...
namespace SnAbp.FeatureManagement.Web.Pages.FeatureManagement
{
    public class FeatureManagementModal : AbpPageModel
    {
        ...
        public FeatureManagementModal(IAppFeatureAppService featureAppService)
        {
            ObjectMapperContext = typeof(SnAbpFeatureManagementWebModule);
