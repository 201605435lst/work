...
{
    public interface IMaterialPurchaseListAppService : IApplicationService
    {
        Task<PurchaseListDto> Get(Guid id);
        Task<PagedResultDto<PurchaseListDto>> GetList(PurchaseListSearchDto input);
        Task<PurchaseListDto> Create(PurchaseListCreateDto input);
        Task<PurchaseListDto> Update(PurchaseListUpdateDto input);
