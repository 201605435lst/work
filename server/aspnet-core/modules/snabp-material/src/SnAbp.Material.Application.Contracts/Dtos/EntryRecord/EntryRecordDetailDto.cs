...
namespace SnAbp.Material.Dtos
{
    ...
    /// 入库记录表
    /// </summary>
    public class EntryRecordDetailDto : EntityDto<Guid>
    {
        public EntryRecordDetailDto(Guid id) => this.Id = id;
        ...
        /// 关联二维码
        /// </summary>
        public List<EntryRecordRltQRCodeDetailDto> EntryRecordRltQRCodes { get; set; }
