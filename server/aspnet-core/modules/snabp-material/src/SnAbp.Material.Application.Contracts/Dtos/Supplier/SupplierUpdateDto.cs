...
{
    public class SupplierUpdateDto : EntityDto<Guid>
    {
        /// <summary>
        /// 名称
        /// </summary>
        ...
        /// 附件
        /// </summary>
        public List<SupplierRltAccessoryCreateDto> SupplierRltAccessories { get; set; }

        /// <summary>
        /// 联系人
        /// </summary>
        public List<SupplierRltContactsUpdateDto> SupplierRltContacts { get; set; }
    }
}
