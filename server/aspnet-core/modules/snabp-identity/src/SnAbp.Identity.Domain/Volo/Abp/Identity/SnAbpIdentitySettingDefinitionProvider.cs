...
{
    public class SnAbpIdentitySettingDefinitionProvider : SettingDefinitionProvider
    {
        public override void Define(ISettingDefinitionContext context)
        {
            context.Add(
                ...
                new SettingDefinition(
                 ...
                 new SettingDefinition(
                    IdentitySettingNames.Organization.MaxUserMembershipCount,
                    int.MaxValue.ToString(), 
                    L("Identity.Organization.MaxUserMembershipCount"),
                    L("Identity.Organization.MaxUserMembershipCount"),
                    true)
            );
        }
