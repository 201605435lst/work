...
namespace SnAbp.Identity
{
    public class IdentityUser : FullAuditedAggregateRoot<Guid>, IUser
    {
        ...
        /// </summary>
        public virtual ICollection<IdentityUserRltRole> Roles { get; protected set; }
        ...
        /// </summary>
        public virtual ICollection<IdentityUserRltOrganization> Organizations { get; protected set; }

        protected IdentityUser()
        {
        }

        public IdentityUser(Guid id, [NotNull] string userName, [NotNull] string email, Guid? tenantId = null, Guid? positionId = null)
        {
        ...
        public virtual void AddRole(Guid roleId)
        {
            ...
            Roles.Add(new IdentityUserRltRole(Id, roleId, TenantId));
        }
        ...
        public virtual void AddOrganization(Guid organizationId)
        {
            ...
            Organizations.Add(
                new IdentityUserRltOrganization(
                    Id,
                    organizationId,
                    TenantId
                )
        ...
        public virtual void RemoveOrganization(Guid organizationId)
        {
            if (!IsInOrganization(organizationId))
            {
                return;
        ...
        public virtual bool IsInOrganization(Guid organizationId)
        {
            return Organizations.Any(
                ou => ou.OrganizationId == organizationId
            );
        }
        public virtual bool IsInOrganizations(List<Guid> organizationIds)
        {
            return Organizations.Any(
                ou => organizationIds.Contains(ou.OrganizationId)
            );
        }
