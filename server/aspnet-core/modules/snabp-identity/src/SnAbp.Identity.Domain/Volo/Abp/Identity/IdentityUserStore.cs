...
namespace SnAbp.Identity
{
        ...
        ITransientDependency
    {
        ...
        public virtual async Task<IList<string>> GetRolesAsync([NotNull] IdentityUser user, CancellationToken cancellationToken = default)
        {
            ...
            var userOrganizationRoles = await UserRepository
                .GetRoleNamesInOrganizationAsync(user.Id, cancellationToken: cancellationToken);

            return userRoles.Union(userOrganizationRoles).ToList();
        }
