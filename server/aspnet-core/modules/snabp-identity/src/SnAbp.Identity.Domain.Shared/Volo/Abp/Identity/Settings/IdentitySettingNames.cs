namespace SnAbp.Identity.Settings
{
    public static class IdentitySettingNames
    {
        ...
        {
            private const string OrganizationPrefix = Prefix + ".Organization";

            public const string MaxUserMembershipCount = OrganizationPrefix + ".MaxUserMembershipCount";
        }
    }
}