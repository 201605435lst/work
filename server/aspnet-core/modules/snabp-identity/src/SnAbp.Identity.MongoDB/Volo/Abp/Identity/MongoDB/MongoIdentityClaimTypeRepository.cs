...
{
    public class MongoIdentityClaimTypeRepository : MongoDbRepository<ISnAbpIdentityMongoDbContext, IdentityClaimType, Guid>, IIdentityClaimTypeRepository
    {
        public MongoIdentityClaimTypeRepository(IMongoDbContextProvider<ISnAbpIdentityMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
