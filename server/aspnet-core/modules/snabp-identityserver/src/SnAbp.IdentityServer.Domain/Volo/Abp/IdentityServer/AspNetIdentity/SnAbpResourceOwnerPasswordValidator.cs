...
{
    public class SnAbpResourceOwnerPasswordValidator : IResourceOwnerPasswordValidator
    {
        ...
        protected IStringLocalizer<SnAbpIdentityServerResource> Localizer { get; }

        public SnAbpResourceOwnerPasswordValidator(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            IEventService events,
            ILogger<ResourceOwnerPasswordValidator<IdentityUser>> logger, 
            IStringLocalizer<SnAbpIdentityServerResource> localizer)
        {
