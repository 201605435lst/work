...
namespace SnAbp.IdentityServer.MongoDB
{
    public class MongoDeviceFlowCodesRepository :
        MongoDbRepository<ISnAbpIdentityServerMongoDbContext, DeviceFlowCodes, Guid>, IDeviceFlowCodesRepository
    {
        public MongoDeviceFlowCodesRepository(
            IMongoDbContextProvider<ISnAbpIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
