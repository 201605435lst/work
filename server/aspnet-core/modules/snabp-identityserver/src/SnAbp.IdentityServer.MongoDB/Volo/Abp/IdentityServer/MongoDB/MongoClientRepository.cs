...
{
    public class MongoClientRepository : MongoDbRepository<ISnAbpIdentityServerMongoDbContext, Client, Guid>, IClientRepository
    {
        public MongoClientRepository(
            IMongoDbContextProvider<ISnAbpIdentityServerMongoDbContext> dbContextProvider
            ) : base(
                dbContextProvider)
        {
        }
