...
{
    public class MongoPersistentGrantRepository : MongoDbRepository<ISnAbpIdentityServerMongoDbContext, PersistedGrant, Guid>, IPersistentGrantRepository
    {
        public MongoPersistentGrantRepository(IMongoDbContextProvider<ISnAbpIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
