...
{
    public class MongoIdentityResourceRepository : MongoDbRepository<ISnAbpIdentityServerMongoDbContext, IdentityResource, Guid>, IIdentityResourceRepository
    {
        public MongoIdentityResourceRepository(IMongoDbContextProvider<ISnAbpIdentityServerMongoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
