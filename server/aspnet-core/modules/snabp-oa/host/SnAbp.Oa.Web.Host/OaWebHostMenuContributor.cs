...
namespace SnAbp.Oa
{
    public class OaWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public OaWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<OaResource>();
