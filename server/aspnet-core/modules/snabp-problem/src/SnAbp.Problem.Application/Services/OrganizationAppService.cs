...
using SnAbp.Problem.Authorization;
using SnAbp.Problem.Dto;
...
{
    //[Authorize(ProblemPermissions.Orgs_Organization)]
    [Authorize]
    public class OrganizationAppService : ProblemAppService, IOrganizationAppService
    {
