...
{
    public class SkylightPlanCreateDto : EntityDto<Guid>, IRepairTagKeyDto
    {
        /// <summary>
        ...
        /// 计划内容
        /// </summary>
        public List<PlanDetailCreateDto> PlanDetails { get; set; }
        ...
        public SkylightPlanCreateDto() { }

        public SkylightPlanCreateDto(Guid id)
        {
            Id = id;
        }
