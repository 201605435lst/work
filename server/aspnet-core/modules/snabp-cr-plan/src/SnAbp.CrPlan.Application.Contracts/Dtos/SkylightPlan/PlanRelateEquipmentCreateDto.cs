...
{
    public class PlanRelateEquipmentCreateDto : EntityDto<Guid>, IRepairTagKeyDto
    {
        /// <summary>
        /// 计划编号
        /// </summary>
        ...
        public PlanRelateEquipmentCreateDto() { }
        public PlanRelateEquipmentCreateDto(Guid id) { Id = id; }
    }
}
