...
*******类 名 称： ProblemLibraryDto
*******类 说 明： 问题库
*******作    者： Easten
*******机器名称： EASTEN
*******CLR 版本： 4.0.30319.42000
*******创建时间： 2021/5/7 15:35:40
...
namespace SnAbp.Safe.Dtos
{
    ...
    /// $$
    /// </summary>
    public class SafeProblemLibraryDto : EntityDto<Guid>
    {
        ...
        public virtual Identity.DataDictionaryDto EventType { get; set; }
        /// <summary>
        /// 所属专业，数字字典
        /// </summary>
        ...
        /// 适用范围，为多选的数字字典
        /// </summary>
        public virtual List<SafeProblemLibraryRltScopDto> Scops { get; set; } = new List<SafeProblemLibraryRltScopDto>();
    }
}
