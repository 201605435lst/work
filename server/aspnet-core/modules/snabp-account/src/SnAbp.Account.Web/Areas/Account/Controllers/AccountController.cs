...
using SnAbp.Account.Web.Areas.Account.Controllers.Models;
using Volo.Abp.AspNetCore.Mvc;
using SnAbp.Identity;
using Volo.Abp.Settings;
using Volo.Abp.Validation;
using SignInResult = Microsoft.AspNetCore.Identity.SignInResult;
using UserLoginInfo = SnAbp.Account.Web.Areas.Account.Controllers.Models.UserLoginInfo;
using IdentityUser = SnAbp.Identity.IdentityUser;
using Volo.Abp;

namespace SnAbp.Account.Web.Areas.Account.Controllers
{
    [RemoteService(Name = AccountRemoteServiceConsts.RemoteServiceName)]
    [Controller]
    [ControllerName("AppLogin")]
    [Area("account")]
    [Route("api/account")]
