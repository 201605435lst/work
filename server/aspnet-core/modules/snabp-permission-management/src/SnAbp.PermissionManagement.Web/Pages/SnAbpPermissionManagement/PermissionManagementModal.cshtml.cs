...
using SnAbp.PermissionManagement.Web.Utils;

namespace SnAbp.PermissionManagement.Web.Pages.AbpPermissionManagement
{
    public class PermissionManagementModal : AbpPageModel
    {
        ...
        public PermissionManagementModal(IAppPermissionAppService permissionAppService)
        {
        ...
        public virtual async Task<IActionResult> OnGetAsync()
        {
            ...
            var result = await PermissionAppService.GetAsync(ProviderName, ProviderGuid);
