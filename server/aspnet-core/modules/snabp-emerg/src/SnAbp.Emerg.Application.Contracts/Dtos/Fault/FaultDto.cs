...
namespace SnAbp.Emerg.Dtos
{
...

    {
        ...
        /// 关联构件
        /// </summary>
        public List<FaultRltComponentCategorySimpleDto> FaultRltComponentCategories { get; set; }
        
        /// <summary>
        /// 关联设备
        /// </summary>
        public List<FaultRltEquipmentSimpleDto> FaultRltEquipments { get; set; }
        ...
        public EmergPlanRecordDto EmergPlanRecord { get; set; }

        /// <summary>
        /// 当前用户可以处理节点id集合
        /// </summary>
        public List<Guid> CurrentNodeIds { get; set; }= new List<Guid>();
