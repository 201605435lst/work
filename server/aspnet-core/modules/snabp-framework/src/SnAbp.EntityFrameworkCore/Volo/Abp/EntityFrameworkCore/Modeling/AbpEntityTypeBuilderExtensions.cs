...
using SnAbp.EntityFrameworkCore.ValueComparers;
...
namespace SnAbp.EntityFrameworkCore.Modeling
{
    public static class AbpEntityTypeBuilderExtensions
    {
        ...
        public static void ConfigureMultiProject<T>(this EntityTypeBuilder<T> b)
           where T : class
        {
            b.As<EntityTypeBuilder>().TryConfigureMultiProject();
        }
        public static void TryConfigureMultiProject(this EntityTypeBuilder b)
        {
            if (b.Metadata.ClrType.IsAssignableTo<IMultiProject>())
            {
                b.Property(nameof(IMultiProject.ProjectId))
                    .IsRequired(false)
                    .HasColumnName(nameof(IMultiProject.ProjectId));
            }
        }
