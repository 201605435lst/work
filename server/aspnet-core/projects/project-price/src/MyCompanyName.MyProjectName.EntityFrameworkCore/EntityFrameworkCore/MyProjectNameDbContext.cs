...
namespace MyCompanyName.MyProjectName.EntityFrameworkCore
{
    ...
    public class MyProjectNameDbContext : AbpDbContext<MyProjectNameDbContext>
    {
        ...
        public DbSet<ProjectRltModule> ProjectRltModule { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                b.ToTable(SnAbpIdentityDbProperties.DbTablePrefix + "Users"); //Sharing the same table "AbpUsers" with the IdentityUser
