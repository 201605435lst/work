...
using SnAbp.AspNetCore.MultiProject;
using SnAbp.AspNetCore.MultiProject.MultiProject;
...
namespace MyCompanyName.MyProjectName
{
    [DependsOn(
        ...
        typeof(AspNetCoreMultiProjectModule)
        )]
    public class MyProjectNameHttpApiHostModule : AbpModule
    {
        ...
        private void ConfigureConventionalControllers()
        {
            Configure<AbpAspNetCoreMvcOptions>(options =>
            {
                ...
                options.ConventionalControllers.Create(typeof(TechnologyApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(CostManagementApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(SafeApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(CostManagementApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(MaterialApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(ConstructionBaseApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(ConstructionApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(QualityApplicationModule).Assembly);
                options.ConventionalControllers.Create(typeof(FileApproveApplicationModule).Assembly);
            });
        }
