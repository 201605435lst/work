...
export default {
  ...
  props: {
    ...
    single: { type: Boolean, default: false },// 单一流程模式
    ...
    if (currentConfig == undefined || currentConfig.nodeProps == undefined) {
      ...
      let code = (
        <a-form-item label="Code">
          <a-input
            ...
            onInput={$event => {
              this.changeHandle('code', $event.target.value);
            }}
          >
      ...
      item = (
        <a-form data-type={this.model.type}>
          ...
          {currentConfig.nodeProps.indexOf('code') > -1 ? code : null}
          {currentConfig.nodeProps.indexOf('member-select') > -1 ? memberSelect : null}
          {this.single?null:currentConfig.nodeProps.indexOf('field-permission') > -1 ? fieldPermission : null}
