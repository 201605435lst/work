...
import SmMaterialOutRecordModal from './SmMaterialOutRecordModal';
...
export default {
  ...
  methods: {
    ...
    //添加
    add() {
      this.$refs.SmMaterialOutRecordModal.add();
    },

    //详情
    view(record) {
      this.$refs.SmMaterialOutRecordModal.view(record);
    },

    // 导出
    async export(id) {
      let response = await apiOutRecord.export(id);
    ...
    async refresh(resetPage = true, page) {
      ...
      let response = await apiOutRecord.getList({
      ...
      if (requestIsSuccess(response) && response.data) {
        this.outRecords = response.data.items;
  ...
  render() {
    return (
      <div class="sm-material-entry-records">
        ...
        >
          ...
          <template slot="buttons">
            {vIf(
              ...
              vP(this.permissions, permissionsSmMaterial.OutRecords.Create),
            )}
            {/* {vIf(
              <a-button
                ...
                return [
                  <span>
                    {vIf(
                      ...
                      vP(this.permissions, permissionsSmMaterial.OutRecords.Detail),
                    )}
                    {vIf(
                      <a-divider type="vertical" />,
                      vP(this.permissions, permissionsSmMaterial.OutRecords.Detail) &&
                      vP(this.permissions, permissionsSmMaterial.OutRecords.Export),
                    )}
        ...
        {/* 添加/查看模板 */}
        <SmMaterialOutRecordModal
          ref="SmMaterialOutRecordModal"
          axios={this.axios}
          onSuccess={() => {
            this.refresh(false);
          }}
