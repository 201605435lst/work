  ...
  methods: {
    ...
    getIcon(type) {
      ...
      case ScopeType.Organization:
        icon = <a-icon style="color:red" type="apartment" />;
        break;

      case ScopeType.Railway:
        icon = <a-icon style="color:#00b8ff" type="branches" />;
        break;

      case ScopeType.Station:
        icon = <a-icon style="color:orange" type="deployment-unit" />;
        break;

      case ScopeType.InstallationSite:
        icon = <a-icon style="color:green" type="environment" />;
        break;
      }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div class="index">
          <a-tag><a-icon style="color:red" type="apartment" />组织 </a-tag>
          <a-tag><a-icon style="color:#00b8ff" type="branches" />线路 </a-tag>
          <a-tag><a-icon style="color:orange" type="deployment-unit" />车站 </a-tag>
          <a-tag><a-icon style="color:green" type="environment" />位置 </a-tag>
        </div>
