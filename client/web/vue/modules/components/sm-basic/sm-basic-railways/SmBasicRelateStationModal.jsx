  ...
  methods: {
        ...
        this.targetObj.map(staItem => {
          ...
          if (temp == null || temp == undefined) {
            ...
            this.stations.push({
              ...
              disableDownKmMark: staItem.disableDownKmMark,
              disableUpKmMark: staItem.disableUpKmMark,
            });
    ...
    onChange(nextTargetKeys, direction, moveKeys) {
      ...
      for (let i = 0; i < nextTargetKeys.length; i++) {
        ...
        let id = '';
        let name = '';
        let disableUpKmMark = false;
        let disableDownKmMark = false;
        for (let j = 0; j < this.targetObj.length; j++) {
          ...
          if (elemObj.id == ele) {
            ...
            id = elemObj.id;
            name = elemObj.name;
            disableUpKmMark = elemObj.disableUpKmMark;
            disableDownKmMark = elemObj.disableDownKmMark;
            break;
          }
        }
        temp.push({ id: ele, kmMark: kmMark, kmMark2: kmMark2, name: name, title: name, key: id, value: id, disableUpKmMark: disableUpKmMark, disableDownKmMark: disableDownKmMark });
      }
                  ...
                  <span>
                    <a-switch
                      ...
                      onChange={value => {
                        ...
                        this.targetObj.find(s => s.id == record.id).disableUpKmMark = record.disableUpKmMark;
                        if (!value) {
                          record.kmMark = 0;
                        }
                        this.reOrder();
                  ...
                  <span>
                    <a-switch
                      ...
                      onChange={value => {
                        ...
                        this.targetObj.find(s => s.id == record.id).disableDownKmMark = record.disableDownKmMark;
                        if (!value) {
                          record.kmMark2 = 0;
                        }
                        this.reOrder();
