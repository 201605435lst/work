...
// 表单字段
export default {
  name: 'SmConstructionMasterPlanContentFrontSelectTreeModal', // 计划详情 选择树 - 模态框
  props: {
  ...
  methods: {
    ...
    addFrontTask(record,list) {
      ...
      this.selectedContentIds = record.antecedents.map(x => x.frontMasterPlanContentId);
    ...
    // 数据提交
    async ok() {
      const response = await apiMasterPlanContent.changeFrontTask(this.selfId, this.selectedContentIds);
