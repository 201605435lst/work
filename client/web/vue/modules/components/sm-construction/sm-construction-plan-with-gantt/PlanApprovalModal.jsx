...
import SmConstructionPlanWithGantt from './SmConstructionPlanWithGantt';
...
export default {
  name: 'PlanApprovalModal', //施工 计划审批 模态框
  props: {
  ...
  methods: {
    ...
    async approved() {
      ...
      let response=await apiPlan.process(data);
