...
import SmStdBasicRltPropertyModal from './SmStdBasicRltPropertyModal';
import SmStdBasicViewEquipmentModal from './SmStdBasicViewEquipmentModal';
...
export default {
  ...
  computed: {
    columns() {
      return [
        ...
        {
          title: '构件分类',
          dataIndex: 'componentCategoryParentParent',
          ellipsis: true,
          scopedSlots: { customRender: 'componentCategoryParentParent' },
        },
        {
          title: '产品名称',
          dataIndex: 'name',
  ...
  methods: {
    ...
    //关联属性
    rltProperty(id) {
      this.$refs.SmStdBasicRltPropertyModal.add(id);
    },

    //查看设备文件
    viewEquipment(id) {
      this.$refs.SmStdBasicViewEquipmentModal.add(id);
    },
  ...
  render() {
    return (
      <div>
        ...
        <a-table
          ...
          {...{
            scopedSlots: {
              ...
              componentCategoryParentParent: (text, record, index) => {
                return (
                  <a-tooltip
                    placement="topLeft"
                    title={record.componentCategory ? record.componentCategory.name : ''}
                  >
                    {record.componentCategory ? record.componentCategory.name : ''}
                  </a-tooltip>
                );
              },
        ...
        <SmStdBasicRltPropertyModal
          ref="SmStdBasicRltPropertyModal"
          axios={this.axios}
          bordered={this.bordered}
          onSuccess={() => {
            this.refresh(false);
        ...
        <SmStdBasicViewEquipmentModal
          ref="SmStdBasicViewEquipmentModal"
          axios={this.axios}
          bordered={this.bordered}
          onSuccess={() => {
            this.refresh(false);
