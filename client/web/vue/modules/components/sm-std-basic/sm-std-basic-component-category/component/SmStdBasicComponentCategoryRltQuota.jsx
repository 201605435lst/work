...
import ApiComponentCategoryRltQuota from '../../../sm-api/sm-std-basic/ComponentCategoryRltQuota';
...
let apiComponentCategoryRltQuota = new ApiComponentCategoryRltQuota();
export default {
  name: 'SmStdBasicComponentCategoryRltQuota',
  props: {
  ...
  methods: {
    async initAxios() {
      ...
      apiComponentCategoryRltQuota = new ApiComponentCategoryRltQuota(this.axios);
      this.quotas = null;
      this.dataSource = null;
      let response = await apiComponentCategoryRltQuota.getListByComponentCategoryId({
    ...
    async save() {
      this.form.validateFields(async (err, values) => {
        if (!err) {
          let response = await apiComponentCategoryRltQuota.editList({
