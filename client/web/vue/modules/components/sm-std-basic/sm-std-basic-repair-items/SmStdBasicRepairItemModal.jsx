    ...
    async edit(record) {
      ...
      if (requestIsSuccess(response)) {
        ...
        record.componentCategoryIds = record.repairItemRltComponentCategories
          ...
          : [];
        record.organizationTypeIds = record.repairItemRltOrganizationTypes.map(item => item.organizationTypeId);
        this.record = record;
        ...
        <a-form form={this.form}>
          ...
          >
            <SmStdBasicComponentCategorySelect
              ...
              treeCheckable={true}
              treeCheckStrictly={true}
              placeholder={this.status == ModalStatus.View ? '' : '请选择设备关联！'}
              v-decorator={[
                'componentCategoryIds',
                {
                  initialValue: [],
