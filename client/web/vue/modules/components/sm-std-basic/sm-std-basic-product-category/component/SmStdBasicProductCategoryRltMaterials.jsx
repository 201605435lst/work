...
import ApiProductCategoryRltMaterial from '../../../sm-api/sm-std-basic/ProductCategoryRltMaterial';
...
let apiProductCategoryRltMaterial = new ApiProductCategoryRltMaterial();
export default {
  name: 'SmStdBasicProductCategoryRltMaterials',
  props: {
  ...
  methods: {
    async initAxios() {
      ...
      apiProductCategoryRltMaterial = new ApiProductCategoryRltMaterial(this.axios);
      this.computerCodes = null;
      this.dataSource = null;
      let response = await apiProductCategoryRltMaterial.getListByProductCategoryId({
    ...
    async refresh(resetPage = true, page) {
      ...
      if (this.computerCodes == null) return;
    ...
    async save() {
      this.form.validateFields(async (err, values) => {
        if (!err) {
          let response = await apiProductCategoryRltMaterial.editList({
  ...
  render() {
    return (
      <div class="sm-std-basic-component-category-rlt-materials">
