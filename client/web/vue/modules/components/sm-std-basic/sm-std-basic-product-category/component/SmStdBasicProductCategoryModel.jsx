...
export default {
  name: 'SmStdBasicProductCategoryModel',
  props: {
  ...
  methods: {
        ...
        this.form.validateFields(async (err, values) => {
          if (!err) {
            ...
            if (this.status === ModalStatus.Add) {
              ...
              response = await apiProductCategory.update(data);
            }
    ...
    async generatedCode() {
      let num = '001';
      let response = await apiProductCategory.getListCode(
