...
export default {
  ...
  props: {
    userMultiple: { type: Boolean, default: true },//是否多选
    axios: { type: Function, default: null },
    placeholder: { type: String, default: '点击选择成员' },
    value: { type: Array, default: () => [] },
    disabled: { type: Boolean, default: false },
    shouIconSelect: { type: Boolean, default: false }, //人员图标
    ...
    simpledisabled: { type: Boolean, default: false }, //查看不可编辑下的背景显示
    showAllOrganization: { type: Boolean, default: false }, // 是否只显示全部组织机构
    showOrganizationTab: { type: Boolean, default: false }, // 是否只显示组织机构选择
  },
  data() {
    return {
      members: [],
    ...
    return (
      <div
        class={{
          ...
          'shouIconSelect': this.shouIconSelect,
          'sm-system-member-select-disabled': this.simpledisabled,
      ...
      >
        {this.iValue.length <= 0 ? (
          !this.disabled ? (
            <span class={{ "empty": !this.shouIconEmpty, shouIconEmpty: this.shouIconSelect }}>
              {this.shouIconSelect ? <a-icon slot="prefix" type="user" /> : <a-icon type="plus" />}
              {this.placeholder}
            </span>
          ) : (
          ...
          <div>
            ...
            {this.selectedUsers.map(item => {
              return (
                <div class={{"selected-item":true,'select-isMultiple':this.shouIconSelect}} >
        ...
        <SmSystemMemberModal
          ...
          showOrganizationTab={this.showOrganizationTab}
          showAllOrganization={this.showAllOrganization}
