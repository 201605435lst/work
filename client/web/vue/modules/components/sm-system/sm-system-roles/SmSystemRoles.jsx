    ...
    columns() {
      return [
        ...
        },
        {
          ...
          scopedSlots: { customRender: 'isDistributed' },
        },
        {
          title: '公开',
          dataIndex: 'isPublic',
  ...
  render() {
    return (
      <div>
        ...
        <a-table
          ...
          {...{
            scopedSlots: {
              ...
              isDistributed: (text, record) => {
                return <a-tag color={record.isDistributed ? 'green' : 'pink'}>
                  {record.isDistributed ? '已分配' : '未分配'}
                </a-tag>;
              },
        ...
        {/* 角色授权模板 */}
        <SmSystemRoleAuthoriseModal
          ref="SmSystemRoleAuthoriseModal"
          axios={this.axios}
          permissionBlackList={this.permissionBlackList}
          onSuccess={() => {
            this.refresh(false);
          }}
        />
