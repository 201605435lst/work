...
export default {
          ...
          if (!err) {
            ...
            if (this.status === ModalStatus.Add) {
              ...
              response = await apiOrganization.create({
                ...values,
                csrgCode:  this.record && this.record.csrgCode ? this.record.csrgCode + '.' + values.csrgCode : values.csrgCode,
              });
              ...
              let data = {
                ...
                csrgCode: this.record && this.record.parent && this.record.parent.csrgCode ? this.record.parent.csrgCode + '.' + values.csrgCode : values.csrgCode,
              };
              // 编辑
  ...
  render() {
    return (
      <a-modal
        class="SmSystemOrganizationModal"
      ...
      >
        <a-form form={this.form}>
              ...
              v-decorator={[
                'name',
                {
                  ...
                  rules: [
                    ...
                    { max: 100, message: '组织机构名称最多输入100字符' },
                  ],
                },
              ]}
            />
          ...
          >
            <a-input
              disabled={this.status == ModalStatus.View}
              placeholder={this.status == ModalStatus.View ? '' : '请输入组织机构编码'}
              v-decorator={[
                'csrgCode',
                {
                  initialValue: '',
                  rules: [
                    { required: true, message: '请输入组织机构编码！', whitespace: true },
                  ],
                },
              ]}
            />
