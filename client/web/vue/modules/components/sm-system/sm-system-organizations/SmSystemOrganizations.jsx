...
export default {
  ...
  methods: {
    ...
    async downloadFile(para) {
      let queryParams = {};
      queryParams = {
        // keyWords:this.queryParams.name,
        // parentId:null,
        ...this.queryParams,
      };
      //执行文件下载
  ...
  render() {
    return (
      <div class="SmSystemOrganizations">
        {/* 操作区 */}
        <sc-table-operator
          onSearch={() => {
        ...
        <a-table
          ...
          rowSelection={{
            ...
            getCheckboxProps: record => {
              return {
                props: {
                  defaultChecked: this.checkedOrgIds.includes(record.id),
                },
              };
            },
          }}
                    ...
                    {vIf(
                      <div style="display: contents;">
                        ...
                        <a-dropdown trigger={['click']}>
                          <a class="ant-dropdown-link" onClick={e => e.preventDefault()} tclass="more">
                            更多 <a-icon type="down" />
                          </a>
                          <a-menu slot="overlay">
