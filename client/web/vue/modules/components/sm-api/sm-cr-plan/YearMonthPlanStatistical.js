...
export default class Api {
  ...
  //导出月计划完成情况统计表
  async exportMonthCompletion(data) {
    return await this.axios({
      url: `${url}/exportMonthCompletion`,
      method: 'post',
      processData: false,
  ...
  //导出月计划完成情况率统计表
  async exportMonthCompletionRates(data) {
    return await this.axios({
      url: `${url}/exprortMonthCompletionRates`,
      method: 'post',
      processData: false,
      // contentType: 'text/plain',
      responseType: 'arraybuffer',
  ...
  //导出年表情况率统计表
  async exportYearCompletionRates(data) {
    return await this.axios({
      url: `${url}/exprortYearCompletionRates`,
      method: 'post',
      processData: false,
      // contentType: 'text/plain',
      responseType: 'arraybuffer',
