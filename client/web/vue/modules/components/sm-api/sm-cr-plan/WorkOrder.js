...
export default class Api {
  ...
  //查询复验人员
  async checkPlatformLiaisonOfficer(params) {
    return await this.axios({
      url: `${url}/checkPlatformLiaisonOfficer`,
      method: 'post',
      params,
    });
  }
  ...
  // 创建派工单测试项的其他附加测试项
  async createWorkOrderTestAdditional(data) {
    return await this.axios({
      url: `${url}/createWorkOrderTestAdditional`,
      method: 'post',
      data,
    });
  }
  ...
  // 获取派工单测试项的其他附加测试项
  async getWorkOrderTestAdditional(params) {
    return await this.axios({
      url: `${url}/getWorkOrderTestAdditional`,
      method: 'get',
      params,
    });
  }
