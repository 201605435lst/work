...
import { OrderState , RepairTagKeys} from '../../_utils/enum';
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      // if (record.orderState == OrderState.Complete) {
      //   this.$message.info("该作业已完成");
      // }
      this.orderState = record.orderState;
        ...
        <sc-table-operator
          ...
          onReset={() => {
            this.queryParams = {
              startTime: null,
              endTime: null,
              workAreaId: this.currentOrganizationId,
              workContent: '',
        ...
        <a-table
          ...
          {...{
            scopedSlots: {
              ...
              orderNo: (text, record, index) => {
                return record.orderNo !== null
                  ? moment(record.creationTime).format('YYYYMMDD') + '-' + record.orderNo
                  : '';
              },
                    ...
                    record.orderState == OrderState.Complete
                      ...
                      : [
                        vIf(
                          ...
                          vP(this.permissions, permissionsSmCrPlan.OtherWorks.Detail) &&
                              vP(this.permissions, [
                                permissionsSmCrPlan.OtherWorks.Finish,
                                permissionsSmCrPlan.OtherWorks.Revoke,
                              ]),
                        ),
                        vIf(
