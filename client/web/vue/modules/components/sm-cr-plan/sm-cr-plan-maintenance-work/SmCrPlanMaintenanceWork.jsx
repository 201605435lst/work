          ...
          {...{
            scopedSlots: {
              ...
              workState: (text, record, index) => {
                let result;
                if (record.workflowState != WorkflowState.All) {
                  result = getWorkflowState(record.workflowState);
                } else {
                  result="待填报";
                }
                return (
              ...
              operations: (text, record) => {
                return <span>
                  ...
                  <span>
                    {
                      record.workflowState == WorkflowState.Finished ||
                        record.workflowState == WorkflowState.Waiting ? 
                        <a
                          onClick={() => {
                            this.remove(record);
                          }}
                          ...
                          <a-menu slot="overlay">
                            ...
                            </a-menu-item>
                            {
                              vIf(
                                ...
                                vP(this.permissions, permissionsSmCrPlan.MaintenanceWork.SubmitApproval),
                              )
                            }
                          </a-menu>
                        </a-dropdown>
