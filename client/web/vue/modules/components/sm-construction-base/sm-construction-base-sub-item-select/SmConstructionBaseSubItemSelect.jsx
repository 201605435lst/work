...
import SmConstructionBaseSubItemSelectModal from './SmConstructionBaseSubItemSelectModal';

let apiSubItemContent = new ApiSubItemContent();


export default {
  name: 'SmConstructionBaseSubItemSelect',
  props: {
  ...
  render() {
    ...
    return (
      <div
        ...
        {/*工序规范选择模态框*/}
        <SmConstructionBaseSubItemSelectModal
          axios={this.axios}
