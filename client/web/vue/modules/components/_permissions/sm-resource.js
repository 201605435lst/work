...
const Equipments = {
  ...
  ExportCode: GroupNameEquipments + Dot + 'ExportCode',
  GenerateCode: GroupNameEquipments + Dot + 'GenerateCode',
  CodeDetail: GroupNameEquipments + Dot + 'CodeDetail',
  WaitingStorage: GroupNameEquipments + Dot + 'WaitingStorage',
  GenerateQuality: GroupNameEquipments + Dot + 'GenerateQuality',
};
