...
instance.interceptors.request.use(
  function(_config) {
    ...
    let organizationTagId = localStorage.getItem('OrganizationTagId');
    if (tokenValue) {
      _config.headers.common['Authorization'] = 'Bearer ' + tokenValue;
      _config.headers.common['ProjectId'] = projectId || '';
      _config.headers.common['organizationId'] = organizationId || '';
      _config.headers.common['OrganizationTagId'] = organizationTagId || '';
    }
    return _config;
  },
  function(error) {
