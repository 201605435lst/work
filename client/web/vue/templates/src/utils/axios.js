...
instance.interceptors.request.use(
  config => {
    ...
    if (tokenValue) {
      ...
      config.headers.common[defaultConfig.storageOptions.projectId] =
        localStorage.getItem(defaultConfig.storageOptions.projectId) || '';
      config.headers.common[defaultConfig.storageOptions.organizationRootTagId] =
        localStorage.getItem(defaultConfig.storageOptions.organizationRootTagId) || '';
    }
    return config;
  },
  error => {
