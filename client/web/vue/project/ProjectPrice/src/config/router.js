...
let routers = [
  ...
  project,
  {
    ...
    meta: { title: '项目编辑', keepAlive: false, permission: [] },
    props: route => {
      return {
        id: route.params.id,
  ...
  },
  {
    ...
    hidden: true,
    component: () => import('@/views/project/Project'),
    meta: { title: '项目预览', keepAlive: false, permission: [] },
    props: route => {
      return {
        id: route.params.id,
        state:  route.params.state,
...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      //   component: RouteView,
      //   meta: { title: '仪表盘', keepAlive: , icon: bxAnaalyse, permission: ['dashboard'] },
      //   children: [
      //     {
      ...
      //       meta: { title: '测试Jsx', keepAlive: true },
      //     },
      //   ],
      // },
