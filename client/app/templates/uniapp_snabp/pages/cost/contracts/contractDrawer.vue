		...
		<view class="uni-table-operator">
			<view class="uni-table-operator-item">
				<view class="uni-form-item uni-column">
					<view class="uni-form-item uni-form-item-title">合同名称</view>
					<input
				...
				<view class="uni-form-item uni-column">
					<view class="uni-form-item uni-form-item-title">合同类型</view>
					<uniPicker
						mode="selector"
						placeholder="请选择合同类型"
				...
				<view class="uni-form-item uni-column">
					<view class="uni-form-item uni-form-item-title">合同日期</view>
