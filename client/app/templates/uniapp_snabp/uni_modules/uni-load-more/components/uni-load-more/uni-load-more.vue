	...
	<view class="uni-load-more" @click="onClick">
		...
		>
			<circle
				...
				r="20"
				fill="none"
				class="uni-load-more__img--android-H5-circle"
				:style="{color: color}"
				:stroke-width="3"
			></circle>
		</svg>
		...
		>
			<view class="uni-load-more__img--android-MP-view-1" :style="{borderTopColor: color, borderTopWidth: iconSize / 12}"></view>
			<view class="uni-load-more__img--android-MP-view-2" :style="{borderTopColor: color, borderTopWidth: iconSize / 12}"></view>
			<view class="uni-load-more__img--android-MP-view-3" :style="{borderTopColor: color, borderTopWidth: iconSize / 12}"></view>
		</view>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
		<view
		...
		>
			<image
				class="uni-load-more__img--ios-H5-image"
...
.uni-load-more__img--android-MP-view-1,
.uni-load-more__img--android-MP-view-2,
.uni-load-more__img--android-MP-view-3 {
	position: absolute;
